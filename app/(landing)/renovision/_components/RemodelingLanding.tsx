...
const VIDEOS: VideoT[] = [
  { name: 'Maya & Lewis', project: 'Full Home Remodel', driveId: '1M8U6cIAkCh0yRXNR9isCKKfJ4I99bcDB' },
  { name: 'Jennifer', project: 'Wetroom Transformation', driveId: '1JOzVluFR_T-ui90U9suqBWbdDpwKxlw8' },
  { name: 'Maria', project: 'Kitchen & Covered Patio', driveId: '1fm3UESlPIBYjdutByizCGP0b6MNuhYg5' },
  { name: 'Pete', project: 'Bathroom Remodel', driveId: '1o8_to9b3siT34t8-vV7WiYY_SalHnxQO' },
  { name: 'Jack', project: 'Deck & Backyard', driveId: '176JLmYNk1krSTKaCkxIS9c3KSl0F040f' },
...
function RmxStyles() {
  return (
    <style>{`
      ...
      .rmx-sa-grid { max-width: 1100px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 22px; align-items: stretch; }
      .rmx-sa-card { background: #fff; border: 1px solid var(--line); border-radius: 6px; padding: 24px 24px; box-shadow: 0 4px 18px rgba(0,0,0,.04); }
      ...
      @media (max-width: 980px) {
        ...
        .rmx-sa-grid { grid-template-columns: 1fr; gap: 16px; max-width: 540px; }
      }
